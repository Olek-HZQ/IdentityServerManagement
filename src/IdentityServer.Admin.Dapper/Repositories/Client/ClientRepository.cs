...
{
    public class ClientRepository : RepositoryBase<Core.Entities.Clients.Client>, IClientRepository
    {
        ...
        public async Task<Core.Entities.Clients.Client> GetClientByClientId(string clientId)
        {
        ...
        public List<Core.Entities.Clients.Client> GetAllClientsAsync()
        {
        ...
        public override async Task<int> InsertAsync(Core.Entities.Clients.Client entity, bool useTransaction = false, int? commandTimeout = null)
        {
            IDbSession session = DbSession;
            session.BeginTrans();
