...
{
    public class UserRepository : RepositoryBase<Core.Entities.Users.User>, IUserRepository
    {
        ...
        public async Task<PagedUserDto> GetPagedAsync(string search, int page, int pageSize)
        {
            ...
            try
            {
                ...
                result.DataPagedList = (await session.Connection.QueryAsync<Core.Entities.Users.User>(clientSecretSqlResult.Sql, clientSecretSqlResult.NamedBindings)).ToList();
