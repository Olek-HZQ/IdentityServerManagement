...
{
    public class ApiResourceRepository : MssqlRepositoryBase<ApiResource>, IApiResourceRepository
    {
        public ApiResourceRepository(DbConnectionConfiguration dbConnectionConfig) : base(dbConnectionConfig)
        {
        }

        public override async Task<ApiResource> GetAsync(int id, bool useTransaction = false, int? commandTimeout = null)
        {
            ...
            var apiResource = await session.Connection.QueryFirstOrDefaultAsync<ApiResource>(sqlResult.Sql, sqlResult.NamedBindings);
        ...
        public async Task<List<ApiResource>> GetApiResourcesByNameAsync(string[] apiResourceNames)
        {
            IDbSession session = DbSession;
            ...
            try
            {
                List<ApiResource> result = (await session.Connection.QueryAsync<ApiResource>(resultSqlResult.Sql, resultSqlResult.NamedBindings)).ToList();
                if (result.Any())
                {
        ...
        public async Task<List<ApiResource>> GetApiResourcesByScopeNameAsync(string[] scopeNames)
        {
            IDbSession session = DbSession;
        ...
        public override async Task<int> InsertAsync(ApiResource entity, bool useTransaction = false, int? commandTimeout = null)
        {
            IDbSession session = DbSession;
        ...
        public override async Task<bool> UpdateAsync(ApiResource entity, bool useTransaction = false, int? commandTimeout = null)
        {
            IDbSession session = DbSession;
            IDbTransaction transaction = session.BeginTrans();
