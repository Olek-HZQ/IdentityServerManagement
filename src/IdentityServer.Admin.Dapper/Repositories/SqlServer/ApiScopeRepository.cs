...
{
    public class ApiScopeRepository : MssqlRepositoryBase<ApiScope>, IApiScopeRepository
    {
        ...
        public async Task<List<ApiScope>> GetAllApiScopeListAsync()
        {
            ...
            var result = (await session.Connection.QueryAsync<ApiScope>(sqlResult.Sql, sqlResult.NamedBindings)).ToList();
        ...
        public async Task<List<ApiScope>> GetApiScopesByNameAsync(string[] scopeNames)
        {
            IDbSession session = DbSession;
        ...
        public override async Task<ApiScope> GetAsync(int id, bool useTransaction = false, int? commandTimeout = null)
        {
            IDbSession session = DbSession;
            ...
            var apiScope = await session.Connection.QueryFirstOrDefaultAsync<ApiScope>(sqlResult.Sql, sqlResult.NamedBindings);
        ...
        public override async Task<int> InsertAsync(ApiScope entity, bool useTransaction = false, int? commandTimeout = null)
        {
            IDbSession session = DbSession;
        ...
        public override async Task<bool> UpdateAsync(ApiScope entity, bool useTransaction = false, int? commandTimeout = null)
        {
            IDbSession session = DbSession;
            IDbTransaction transaction = session.BeginTrans();
