...
{
    public class PersistedGrantRepository : RepositoryBase<Core.Entities.PersistedGrant>, IPersistedGrantRepository
    {
        ...
        public async Task<Core.Entities.PersistedGrant> GetByKeyAsync(string key)
        {
            ...
            var result = await session.Connection.QueryFirstOrDefaultAsync<Core.Entities.PersistedGrant>(sqlResult.Sql, sqlResult.NamedBindings);
        ...
        public async Task<IEnumerable<Core.Entities.PersistedGrant>> GetListBySubjectIdAsync(string subjectId)
        {
        ...
        public override async Task<int> InsertAsync(Core.Entities.PersistedGrant entity, bool useTransaction = false, int? commandTimeout = null)
        {
        ...
        public override async Task<bool> UpdateAsync(Core.Entities.PersistedGrant entity, bool useTransaction = false, int? commandTimeout = null)
        {
