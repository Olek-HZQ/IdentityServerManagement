...
namespace IdentityServer.AuthIdentity.Quickstart.Account
{
    /// <summary>
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            IClientStore clientStore,IUserService userService,
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (await _userService.ValidateCustomerAsync(model.Username,model.Password))
                {
                    ...
                    await _events.RaiseAsync(new UserLoginSuccessEvent(user.Name, user.SubjectId, user.Name, clientId: context?.Client.ClientId));
