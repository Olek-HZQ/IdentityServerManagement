        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubjectId = table.Column<string>(maxLength: 128, nullable: false),
                    Name = table.Column<string>(maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApiResourceId = table.Column<int>(nullable: false),
                    ApiResourceName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Scope = table.Column<string>(maxLength: 20, nullable: false),
                    ApiResourceId = table.Column<int>(nullable: false),
                    ApiResourceName = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimType = table.Column<string>(maxLength: 512, nullable: false),
                    ClaimValue = table.Column<string>(maxLength: 512, nullable: false)
                },
                constraints: table =>
                {
